...
/**
 * @brief AC_LEDStripe_2 Constructor.
 * @param pinLed  Pin of the LED Stripe
 */
AC_LEDStripe_2::AC_LEDStripe_2(int iniR, int iniG, int iniB)
{
  // Pin Configuration
  _iniR = iniR;
  _iniG = iniG;
 ...
 */
void AC_LEDStripe_2::setFromSensor(int sensorRead){
