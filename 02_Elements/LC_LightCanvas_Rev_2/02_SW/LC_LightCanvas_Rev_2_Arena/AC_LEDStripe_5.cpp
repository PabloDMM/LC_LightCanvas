...
/**
 * @brief AC_LEDStripe_5 Constructor.
 * @param pinLed  Pin of the LED Stripe
 */
AC_LEDStripe_5::AC_LEDStripe_5(int iniR, int iniG, int iniB)
{
  // Pin Configuration
  _iniR = iniR;
  _iniG = iniG;
 ...
 */
void AC_LEDStripe_5::setFromSensor(int sensorRead){
