...
/**
 * @brief AC_LEDStripe_4 Constructor.
 * @param pinLed  Pin of the LED Stripe
 */
AC_LEDStripe_4::AC_LEDStripe_4(int iniR, int iniG, int iniB)
{
  // Pin Configuration
  _iniR = iniR;
  _iniG = iniG;
 ...
 */
void AC_LEDStripe_4::setFromSensor(int sensorRead){
