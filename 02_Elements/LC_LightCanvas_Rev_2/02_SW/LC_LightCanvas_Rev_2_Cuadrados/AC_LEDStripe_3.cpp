...
/**
 * @brief AC_LEDStripe_3 Constructor.
 * @param pinLed  Pin of the LED Stripe
 */
AC_LEDStripe_3::AC_LEDStripe_3(int iniR, int iniG, int iniB)
{
  // Pin Configuration
  _iniR = iniR;
  _iniG = iniG;
 ...
 */
void AC_LEDStripe_3::setFromSensor(int sensorRead){
